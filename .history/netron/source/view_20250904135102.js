...
view.View = class {
    ...
    async showExplainProperties() {
        ...
        try {
            ...
            this._sidebar.open(sidebar, 'Model Explanation');
        } catch (error) {
...
view.ExplainSidebar = class extends view.ObjectSidebar {
    ...
    _renderLoading() {
        this.element.innerHTML = '';
        const loadingDiv = this.createElement('div', 'sidebar-section');
        loadingDiv.innerHTML = `
            <div style="text-align: center; padding: 20px;">
                <div style="margin-bottom: 10px;">🔍 分析模型中...</div>
    ...
    _renderError(error) {
        this.element.innerHTML = '';
        const errorDiv = this.createElement('div', 'sidebar-section');
        errorDiv.innerHTML = `
            <div style="text-align: center; padding: 20px;">
                <div style="margin-bottom: 10px; color: #d32f2f;">❌ 分析失敗</div>
                <div style="font-size: 10px; color: #666;">
                    ${error.message || '未知錯誤'}
                </div>
            </div>
    ...
    _renderContent() {
        ...
        const validationResult = this._analysisResult.validationResult;
        const dummyRunResult = this._analysisResult.dummyRunResult;
