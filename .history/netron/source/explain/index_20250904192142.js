    ...
    async analyzeModel(model, modelBuffer = null) {
        try {
            ...
            if (this.settings.autoDetectLLM || this.settings.enableLLM) {
                ...
                console.log('🤖 [ExplainEngine] LLM 可用性:', llmAvailable);
                ...
                if (llmAvailable) {
                    try {
                        ...
                        console.log('🔍 [ExplainEngine] LLM 驗證結果:', validationResult);
                        ...
                        console.warn('❌ [ExplainEngine] LLM 生成失敗，回退到規則引擎:', llmError.message);
