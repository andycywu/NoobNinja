...
export class SettingsManager {
    ...
    getLLMConfig() {
        ...
        console.log('🔧 [SettingsManager] getLLMConfig 呼叫結果:', config);
        console.log('🔧 [SettingsManager] 所有設定值:', this.settings);
            ...
            <div class="settings-content">
                ...
                <div class="settings-group ollama-settings">
                    ...
                    <div class="settings-field">
                        ...
                        <small class="settings-hint">如果模型不存在，請先執行: ollama pull llama3.2</small>
                    </div>
                </div>
